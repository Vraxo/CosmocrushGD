// MODIFIED: DamageIndicator.cs
// Summary: Use GlobalPosition in Setup because the node is now TopLevel.
// - Changed `Position = startPosition` to `GlobalPosition = globalStartPosition`.
