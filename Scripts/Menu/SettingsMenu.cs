...
public partial class SettingsMenu : CenterContainer
{
    ...
    public override void _Ready()
    {
        ...
        if (titleLabel is null) { initializationFailed = true; GD.PrintErr("SettingsMenu: Title Label not assigned!"); }
        if (musicSlider is null) { initializationFailed = true; GD.PrintErr("SettingsMenu: Music Slider not assigned!"); }
        if (sfxSlider is null) { initializationFailed = true; GD.PrintErr("SettingsMenu: SFX Slider not assigned!"); }
        if (musicLabel is null) { initializationFailed = true; GD.PrintErr("SettingsMenu: Music Label not assigned!"); }
        if (sfxLabel is null) { initializationFailed = true; GD.PrintErr("SettingsMenu: SFX Label not assigned!"); }
        if (applyButton is null) { initializationFailed = true; GD.PrintErr("SettingsMenu: Apply Button not assigned!"); }
        if (returnButton is null) { initializationFailed = true; GD.PrintErr("SettingsMenu: Return Button not assigned!"); }
    ...
    private void StartFadeInAnimation()
    {
        ...
        {
            GD.PrintErr("SettingsMenu: Cannot start animation, one or more UI nodes are null.");
            return;
        }
